    ...
    <div class="container-fluid page-body-wrapper">
      ...
      <nav class="sidebar sidebar-offcanvas" id="sidebar">
        <ul class="nav">
          ...
          <li class="nav-item"> 
            <a class="nav-link" href="show_company?username=<%=name%>">
              <span class="menu-title">Dashboard</span>
              <i class="mdi mdi-home menu-icon"></i>
            </a>
          </li>
          <li class="nav-item">
           <a class="nav-link" href="CompanyShortage?username=<%=name%>">
          ...
          <div class="row">
            <div class="col-md-8 stretch-card grid-margin">
              <div class="card bg-gradient-danger card-img-holder text-white">
                <div class="card-body">
                  <img src="C:/Users/Grad57/git/repository/Settlement/WebContent/images/dashboard/circle.svg" class="card-img-absolute" />
